...
namespace Task1API.Controllers
{
    public class CustomersController : ApiController
    {
        ...
        public CustomerModel AddCustomer(JObject data)
        {
            ...
            var LastID = customersService.AddCustomer(name, address, city, state, zip);

            var customer_results = customersService.GetCustomer(LastID);
